...
public class DomUtils {
	 ...
	 * 
	 * @param el
	 *            Element whose attrib is looked for
	 * @param attrName
	 ...
	 *            Element whose attrib is looked for
	 * @param namespaceURI
	 *            namespace URI of attribute to look for
	 * @param localPart
	 ...
	 * 
	 * @param parentEl
	 *            the element whose cdata/text node values are to be combined.
	 ...
	 * 
	 * @param elem
	 *            the element whose children are to be searched
	 * @param attrName
	 *            the attrib that must be present
	 * @param attrValue
	...
	public static Element findChildElementWithAttribute(Element elem,
		...
		for (Node n = elem.getFirstChild(); n != null; n = n.getNextSibling()) {
			if (n.getNodeType() == Node.ELEMENT_NODE) {
				if (attrValue.equals(DomUtils.getAttribute((Element) n,
						attrName))) {
					return (Element) n;
				}
			}
	 ...
	 * 
	 * @param context
	 *            the starting node (looks up recursively from here)
	 * @param prefix
